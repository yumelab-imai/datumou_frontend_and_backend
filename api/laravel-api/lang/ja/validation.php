...
return [
    ...
    */
    ...
    'digits_between' => ':attribute は :max 桁以下のみ有効です。',
    ...
    'tel' => ':attribute は電話番号形式のみ有効です。',
    'zen_katakana' => ':attribute は全角カタカナ数字のみ有効です。',
    'zen_katakana_meigi' => ':attribute は全角カタカナ英数字と丸括弧のみ有効です。',
    'hiragana' => ':attribute はひらがなのみ有効です。',
    'plate_hiragana' => ':attribute はひらがなと半角のアルファベット（大文字）のみ有効です。',
    'latitude' => ':attribute は正しい緯度形式のみ有効です。',
    'longitude' => ':attribute は正しい経度形式のみ有効です。',
    'affiliation_store_exists' => ':attribute は所属店舗のみ指定可能です。',
    'affiliation_store_account_exists' => ':attribute は無効な値です。',
    'valid_date' => ':attribute を有効な日付形式にしてください。',
    'register_count' => ':attribute は :min ～ :max 個まで登録可能です。',
    'hour' => ':attribute は 開始時間 より後の時刻にしてください。',
    ...
    */
    ...
    'attributes' => ['title' => 'タイトル', 'email' => 'メールアドレス'],
    ...
    */
    ...
    // クリニック関連
    'clinicCode' => '住所の項目を正しく入力してください',
    'storeName' => '住所の項目を正しく入力してください',
    'prefectures_cd' => '都道府県の項目が正しくありません',
    'address' => '住所の項目を正しく入力してください',
    'latitude' => '緯度を適切な数値(-90.000000 ~ 90.000000)で入力してください',
    'longitude' => '緯度を適切な数値(-180.000000 ~ 180.000000)で入力してください',
];
